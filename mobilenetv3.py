...
MobileNetV3_Small = MobileNetV3(mode='small', classes_num=args.num_classes, input_size=32, width_multiplier=width_multiplier)
MobileNetV3_Large = MobileNetV3(mode='large', classes_num=args.num_classes, input_size=32, width_multiplier=width_multiplier)
